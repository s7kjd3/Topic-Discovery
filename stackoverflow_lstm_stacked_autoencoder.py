...
def lstm():
    ...
    x2 = LSTM(150, return_sequences=True,name='lstm_2')(embedded_sequences)
    encoded = LSTM(50,name='lstm_3')(x2)

    x3 = RepeatVector(MAX_SEQUENCE_LENGTH,name='layer_repeat')(encoded)
    x4 = LSTM(50, return_sequences=True,name='lstm_4')(x3)
    x5 = LSTM(150, return_sequences=True,name='lstm_5')(x4)
    decoded = LSTM(300, return_sequences=True,name='lstm_6')(x5)
    print decoded
...
def write_vec_to_csv(doc_vector_train,labels, csvname):
    ...
    with open('stackoverflow_stacked_50_' + csvname + '_.csv', 'w') as f:
        fieldnames = ['content']
