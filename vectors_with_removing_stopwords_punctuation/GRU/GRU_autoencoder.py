...
from keras.layers import Input, LSTM, RepeatVector,TimeDistributed,Dense,Dropout,Embedding,Flatten,GRU
...
def GRU():
    ...
    encoded = keras.layers.recurrent.GRU(300)(embedded_sequences)
   ...
   # x4 = LSTM(75, return_sequences=True,name='lstm_4')(x3)
    ...
    decoded = keras.layers.recurrent.GRU(300, return_sequences=True,activation='linear')(x3)
    ...
    #
    #
    csvname = 'Amazon_GRU_autoencoder'
