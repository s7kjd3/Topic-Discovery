...
from keras.layers import Input, LSTM, RepeatVector,TimeDistributed,Dense,Dropout,Embedding,Flatten,SimpleRNN
...
def lstm():
    ...
    encoded = SimpleRNN(300,name='lstm_3')(embedded_sequences)
   ...
   # x4 = LSTM(75, return_sequences=True,name='lstm_4')(x3)
    ...
    decoded = SimpleRNN(300, return_sequences=True,activation='linear',name='lstm_6')(x3)
