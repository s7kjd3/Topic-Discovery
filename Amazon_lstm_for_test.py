...
from keras.layers import Input, LSTM,merge, RepeatVector,TimeDistributed,Dense,Dropout,Embedding,Masking,Reshape,Lambda,Merge
...
def lstm_words():
    ...
    seq_encoded = LSTM(300)(seq_encoded)
    print seq_encoded
    ...
    seq_decoded = Lambda(new_shape)(seq_decoded)
    seq_decoded = Merge(seq_decoded,mode='concat')
    print seq_decoded
