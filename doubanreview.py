...
from textblob import unicodecsv
...
def get_data():
    path = r'/home/flipped/Windows/Linux_Project/xiangmu/baseline/doubanmovieshortcomments'
    ...
    #         comments.append(row[4] for row in df)
