...
from sklearn.cluster import AgglomerativeClustering, hierarchical, DBSCAN, SpectralClustering, SpectralCoclustering, \
    spectral_clustering
...
def cluster():
    ...
    filename = 'reviews_30_100_lstm_autoencoder_representation_.csv'
