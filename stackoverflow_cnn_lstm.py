...
from keras.layers import Input, LSTM,merge, Conv1D,RepeatVector,TimeDistributed,Dense,Dropout,Embedding,Masking,Reshape,Lambda,SimpleRNN
...
def lstm():
    ...
    # c1 = Conv1D(300, 5, activation='relu', padding='same')(embedded_sequences)
    # print c1
    # # c1 = MaxPooling1D(5)(c1)
    # # print c1
    #
    # c2 = Conv1D(150, 5, activation='relu', padding='same')(c1)
    # print c2
    # # c2 = MaxPooling1D(5)(c2)
    # # print c2

    c3 = Conv1D(50, 5, activation='relu', padding='same')(embedded_sequences)
    print c3
    ...
    encoded = LSTM(50,name='lstm_3')(c3)

    x3 = RepeatVector(MAX_SEQUENCE_LENGTH,name='layer_repeat')(encoded)

    x4 = LSTM(50, return_sequences=True,name='lstm_4')(x3)
    # c4 = Conv1D(50, 5, activation='relu', padding='same')(x4)
    # print c4
    # # c4 = UpSampling1D(5)(c4)
    # # print c4
    #
    #
    # c5 = Conv1D(150, 5, activation='relu', padding='same')(c4)
    # print c5
    # # c5 = UpSampling1D(5)(c5)
    # # print c5

    c6 = Conv1D(300, 5, activation='relu', padding='same')(x4)
    print c6

    #x5 = LSTM(150, return_sequences=True,name='lstm_5')(x3)
    # decoded = LSTM(300, return_sequences=True,activation='softmax',name='lstm_6')(x3)
    # print decoded
    sequence_autoencoder = Model(sequence_input, c6)
...
def write_vec_to_csv(doc_vector_train,labels, csvname):
    ...
    with open('stackoverflow_cnn_' + csvname + '_.csv', 'w') as f:
        fieldnames = ['content']
